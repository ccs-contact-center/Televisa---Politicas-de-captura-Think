...
import audio from '../../assets/img/Audios/diapositiva 34 audio 1.mp3'
...
class TA16View extends Component {
  loading = () => (
      ...
      <div className="animated fadeIn">
        ...
        <CardBody >
          <Row className="centrado-fila">
            <Col xs="12">
              <h1>8. ¿En qué casos puedes utilizar la palabra CALLE en Address 1?
              </h1>
            </Col>
                        ...
                        <div className="centrado-fil">
                          <div>
                            <Label check>
                              ...
                              />
                              A) La palabra calle en la dirección cuando forme parte del nombre de la vialidad,
                              Ejemplo: CALLE 45, CALLE B.
                            </Label>
                          </div>
                        </div>
                      </FormGroup>
                          ...
                          <div>
                            <Label check>
                              <Input
                                ...
                                onChange={this.onChange.bind(this)}
                              />
                              B) En ningún caso, solo se captura el nombre de la calle.
                            </Label>
                          </div>
                        </div>
                      </FormGroup>
                          ...
                          <div>
                            <Label check>
                              <Input
                                ...
                                onChange={this.onChange.bind(this)}
                              />
                              C) Cuando no cuente con numero exterior o interior.
