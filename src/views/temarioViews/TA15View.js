...
import audio from '../../assets/img/Audios/diapositiva 31 audio 1.mp3'
...
class TA15View extends Component {
  loading = () => (
      ...
      <div className="animated fadeIn">
        ...
        <CardBody >
          <Row className="centrado-fila">
            <Col xs="12">
              <h1>7. ¿En qué página debes validar el CP?
              </h1>
            </Col>
