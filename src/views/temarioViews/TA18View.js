...
import audio from '../../assets/img/Audios/diapositiva 40 audio 1.mp3'
...
class TA18View extends Component {
  loading = () => (
      ...
      <div className="animated fadeIn">
        ...
        <CardBody >
          <Row className="centrado-fila">
            <Col xs="12">
              <h1>10. La captura de dos o más nombres de
                distinto genero (masculino/femenino),
                no deberá ser separada por ninguna conjunción (Y, E).
